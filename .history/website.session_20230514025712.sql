...
CREATE TABLE PersonalAccounts (Username VARCHAR(50) NOT NULL PRIMARY KEY ,Fixed_Deposit MONEY DEFAULT 0,Personal_Contributions MONEY, FOREIGN KEY(Username) REFERENCES mon);
