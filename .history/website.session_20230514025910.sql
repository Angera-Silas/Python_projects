...
CREATE TABLE PersonalAccounts (Username VARCHAR(50) NOT NULL PRIMARY KEY ,Fixed_Deposit deCIMAL(10) DEFAULT 0,Personal_Contributions DECIMAL(18,2) DEFAULT 0, FOREIGN KEY(Username) REFERENCES monthlyContribution(Username) ON UPDATE CASCADE ON DELETE CASCADE);
