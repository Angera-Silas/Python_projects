...
CREATE TABLE membersInfo(Username VARCHAR(50) NOT NULL FOREIGN KEY REFERENCES registration(Username) ON DELETE CASCADE ON UPDATE CASCADE,Id_no INT(10) NO
