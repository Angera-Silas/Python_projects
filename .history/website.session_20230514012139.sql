...
SELECT * FROM `membersInfo`;
ALTER TABLE registration MODIFY Age INT AS (TIMESTAMPDIFF(YEAR,Registration_Date,Date_of_birth));

ALTER TABLE registration MODIFY Date_of_birth DATETIME NOT NULL;