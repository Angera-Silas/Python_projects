...
CREATE TABLE membersInfo(Username VARCHAR(50) NOT NULL,Id_no INT(10) NOT NULL PRIMARY KEY,Phone_number INT(12) NOT NULL UNIQUE,Registration_fee DECIMAL(18,2) DEFAULT 0.00,);